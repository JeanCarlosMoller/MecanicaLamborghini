...
class procedure TControllerItemServico.Get(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
begin
  FDAO := TDAOItemServico.Create;
  inherited;
...
class procedure TControllerItemServico.Gets(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
begin
  FDAO := TDAOItemServico.Create;
  inherited;
...
class procedure TControllerItemServico.Post(Req: THorseRequest;
  Res: THorseResponse; Next: TProc);
begin
  FDAO := TDAOItemServico.Create;
  inherited;
